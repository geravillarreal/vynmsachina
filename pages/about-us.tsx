    ...
    <Layout title='关于我们'>
      ...
      <div className={styles.section}>
        <div className={styles.content}>
          ...
          <span>VYNMSA（秉厦）始终致力于满足客户的需求，已经成功为来自全球25个国家（中国、日本、 韩国、墨西哥、美国、加拿大、阿根廷、 德国、西班牙、意大利、法国、奥地利、英国、丹麦等）的企业成功交付了500多个项目、 建筑总面积达250万平方米。 在过去的六年中，我们与中国、韩国和日本的公司 建立了良好的合作关系，在墨西哥同行业中拥有最多的亚洲客户，共同开展了40个项目。</span>
        </div>
